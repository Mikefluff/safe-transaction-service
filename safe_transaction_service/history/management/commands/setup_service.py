...
MASTER_COPIES: Dict[EthereumNetwork, List[Tuple[str, int, str]]] = {
    EthereumNetwork.HUOBI: [
        ('0xE51abdf814f8854941b9Fe8e3A4F65CAB4e7A4a8', 6112968, '1.3.0+L2'),
        ('0xb4A7C7da1631CF60A2Cf23ABc86986f99a1A7f70', 6112971, '1.3.0'),
    ],
}

PROXY_FACTORIES: Dict[EthereumNetwork, List[Tuple[str, int]]] = {
    EthereumNetwork.HUOBI: [
        ('0xE89ce3bcD35bA068A9F9d906896D3d03Ad5C30EC', 6112951),  # v1.3.0
    ],
}
